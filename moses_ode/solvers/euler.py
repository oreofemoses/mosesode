...
def euler_solver(f, t0, y0, h, t_end):
    """
    ...
    logger.info(f"Solving ODE using Euler method from t={t0} to t={t_end} with step size h={h}.")
    ...
    logger.info("Euler solver completed successfully.")
